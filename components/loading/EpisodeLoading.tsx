 ...
 */
const EpisodeLoading: React.FC<EpisodeLoadingProps> = ({ className = "" }) => {
  return (
            ...
            <div className="glass-container p-0 overflow-hidden">
              <div className="aspect-video bg-gray-900/80 flex items-center justify-center">
                <div className="flex flex-col items-center gap-4 text-gray-300">
                  ...
                  <span className="text-lg font-medium">Loading Episode...</span>
                  <span className="text-sm opacity-75">Preparing video player</span>
                </div>
              </div>
